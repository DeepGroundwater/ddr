...
| `COMID_DRAIN_SQKM`| Upstream area (km²) from MERIT river network                      |
| `PCT_DIFF`        | `(DRAIN_SQKM - COMID_DRAIN_SQKM) / DRAIN_SQKM * 100`            |
| `REL_ERR`         | `(COMID_DRAIN_SQKM - DRAIN_SQKM) / DRAIN_SQKM`                  |
